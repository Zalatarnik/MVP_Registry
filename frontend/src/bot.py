...
PUBLIC_PATH = 'C:/Users/nikno/Desktop/site_gasu/MVP_Registry/frontend/public/'

# Файлы для хранения данных (с полным путем)
USERS_FILE = os.path.join(PUBLIC_PATH, 'users.json')
FORMS_FILE = os.path.join(PUBLIC_PATH, 'forms.json')
ADMINS_FILE = os.path.join(PUBLIC_PATH, 'admins.json')
PENDING_ADMINS_FILE = os.path.join(PUBLIC_PATH, 'pending_admins.json')
